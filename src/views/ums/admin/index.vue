    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="公司" align="center">
          <template slot-scope="scope">{{scope.row.companyId|convertCompanyName}}</template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form :model="admin"
        ...
        <el-form-item label="公司：">
          <el-select v-model="admin.companyId" placeholder="请选择" size="small" style="width: 80%">
            <el-option
...
<script>
  ...
  export default {
    ...
    filters: {
      ...
      convertCompanyName(id) {
        if (id == null || id === '') {
          return 'N/A';
        }
        let companyName = "";
        that.companyList.forEach(company => {
          if (company.id == id) {
    ...
    methods: {
      ...
      handleAllocDialogConfirm() {
        this.$confirm('是否要确认?', '提示', {
          ...
          params.append("memberId", this.allocAdminId);
